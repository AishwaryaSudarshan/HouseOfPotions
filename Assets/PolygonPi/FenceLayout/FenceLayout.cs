...
{
    public List<Vector3> FencePoints = new();
    public Transform[] FencePrefabs = new Transform[1];
    public Transform PostPrefab;
    public Vector3 FenceEndOffset = new();
    public float FenceRotation = 0.0f;
    public float FenceLength = 2.0f;
    public Vector3 FenceScale = new(1, 1, 1);
    public bool CompleteLoop = false;
    public bool ObjectMode = false;
    public Vector2 PositionVariation = new(0, 0);
    public Vector2 RotationVariation = new(-180, 180);
    public Vector2 ScaleVariation = new(1, 1);
    ...
    public int GetAddPointIdx()
    {
        ...
        else
        {
            ...
            {
                if (Vector3.Dot(addPos - FencePoints[^1], FencePoints[^2] - FencePoints[^1]) > 0)
                {
